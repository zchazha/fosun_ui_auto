...
class DataProvide():
    @staticmethod
    def phone():
        phone_start = random.choice(["130","131","132","133","134","135","136","137","138","139",
                                     "181","182","183","184","185"])
        phone_mid = time.strftime("%m%d")
        phone_end = str(random.randint(0,9999)).zfill(4)
    ...
    def name():
        ...
        second_name = ['的', '一', '是', '了', '我', '不', '人', '在', '他', '有', '这', '个', '上', '们', '来', '到', '时', '大', '地',
        ...
        if random.randint(0,1) == 0:
            ...
            name = ('' + first_name[x] + second_name[m1] )
        return name

    @staticmethod
    def getdistrictcode():
        codelist = []
        file = open(var_config.parent_dir_path + "\\util\\districtcode.txt",encoding="utf-8")
    ...
    @staticmethod
    def id():
        codelist = DataProvide.getdistrictcode()
    ...
    def bank_account():
        prefix="622636" #华夏银行
        #prefix = "622202"  # 工行卡号开头
        #prefix = "622609"  # 招行卡
        card = prefix + str(random.randint(0, 9999999999999)).zfill(13)
        return card

    @staticmethod
    def get_four_data():
        data=[]
        data.extend([DataProvide.name(),DataProvide.id(),DataProvide.bank_account(),DataProvide.phone() ])
        return  data

if __name__ == '__main__':
    print (type(DataProvide.id()))
    print (type(DataProvide.bank_account()))
    print (type(DataProvide.phone()))
